...
# lggFemaleBlobfish <- read.csv(paste0(sourceDir, "CGGA/Blobfish_Results/LGG_Female_Panda_BLOBFISH_Full.csv"),
#                               row.names = 1)
# gbmFemaleBlobfish <- read.csv(paste0(sourceDir, "CGGA/Blobfish_Results/GBM_Female_Panda_BLOBFISH_Full.csv"),
#                               row.names = 1)
# lggMaleBlobfish <- read.csv(paste0(sourceDir, "CGGA/Blobfish_Results/LGG_Male_Panda_BLOBFISH_Full.csv"),
#                               row.names = 1)
# gbmMaleBlobfish <- read.csv(paste0(sourceDir, "CGGA/Blobfish_Results/gbmMaleSimplifiedBLOBFISH.csv"),
#                               row.names = 1)
# 
...
# gbmFemaleToPathway[which(gbmFemaleToPathway$gene %in% mrnaGenes), "pathway"] <- "mRNA Splicing"
...
# gbmFemaleToPathway[which(gbmFemaleToPathway$gene %in% cancerGenes), "pathway"] <- "RCC HIF1A Activity"
...
# gbmMaleToPathway[which(gbmMaleToPathway$gene %in% mrnaGenes), "pathway"] <- "mRNA Splicing"
...
# gbmMaleToPathway[which(gbmMaleToPathway$gene %in% cancerGenes), "pathway"] <- "RCC HIF1A Activity"
...
# geneColorMappingFemale[which(uniqueGenesFemale == "mRNA Splicing"), "color"] <- mrnaColor
...
# geneColorMappingFemale[which(uniqueGenesFemale == "RCC HIF1A Activity"), "color"] <- cancerColor
...
gbmFemaleSimplified <- read.csv(paste0(sourceDir, "CGGA/Blobfish_Results/gbmFemaleSimplifiedBLOBFISH.csv"),
                              row.names = 1)
...
# geneColorMappingMale[which(uniqueGenesMale == "mRNA Splicing"), "color"] <- mrnaColor
...
# geneColorMappingMale[which(uniqueGenesMale == "RCC HIF1A Activity"), "color"] <- cancerColor
...
gbmMaleSimplified <- read.csv(paste0(sourceDir, "CGGA/Blobfish_Results/gbmMaleSimplifiedBLOBFISH.csv"),
                                row.names = 1)
