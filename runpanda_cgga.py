...
#Expression data
localDir = '../CGGA'
expression_data_LGG_Female= localDir + '/maleLGG_CGGA.csv'
expression_data_LGG_Male= localDir + '/femaleLGG_CGGA.csv'
expression_data_GBM_Female= localDir + '/femaleGBM_CGGA.csv'
expression_data_GBM_Male= localDir + '/maleGBM_CGGA.csv'

#Motif data
Female_motif_data     =localDir + '/Symbol_MotifPriorGencode_p5_female_PARonX.txt'
Male_motif_data = localDir + '/Symbol_MotifPriorGencode_p5.txt'

#PPI data
ppi_data       =localDir + '/ppi_Gencode_p5.txt'

#Output path
LGG_Female_panda_output   =localDir + '/LGG_Female_Panda_output_CGGA.txt'
LGG_Male_panda_output   =localDir + '/LGG_Male_Panda_output_CGGA.txt'
GBM_Female_panda_output   =localDir + '/GBM_Female_Panda_output_CGGA.txt'
GBM_Male_panda_output   =localDir + '/GBM_Male_Panda_output_CGGA.txt'
